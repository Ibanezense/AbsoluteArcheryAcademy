-- ============================================================================
-- Fix: avoid ledger movement-type conflicts on membership renewal
-- Fecha: 2026-04-01
-- Proposito:
-- 1. Mantener la acumulacion de clases sobre la membresia activa
-- 2. Registrar la renovacion usando el movement_type existente
-- 3. Evitar conflictos si la base no acepta membership_renewal en ledger
-- ============================================================================
...
COMMENT ON FUNCTION public.admin_assign_membership_plan(uuid, uuid, date, numeric, numeric, text) IS
  'Vende o renueva una membresia V2 para un alumno. Si ya existe una activa, acumula nuevas clases sobre la misma membresia y registra la renovacion en ledger usando movement_type compatible.';
