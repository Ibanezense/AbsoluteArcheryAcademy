-- ============================================================================
-- Fix: restore fresh membership cycles on every new membership sale
-- Fecha: 2026-04-16
-- Proposito:
-- 1. Mover cualquier membresia activa previa a historical
-- 2. Crear una nueva membresia activa limpia para el nuevo ciclo
-- 3. Mantener el historial completo de clases y reservas en la membresia anterior
-- ============================================================================
...
COMMENT ON FUNCTION public.admin_assign_membership_plan(uuid, uuid, date, numeric, numeric, text) IS
  'Vende una nueva membresia V2 para un alumno, mueve la membresia activa previa a historico y crea un nuevo ciclo limpio de clases.';
