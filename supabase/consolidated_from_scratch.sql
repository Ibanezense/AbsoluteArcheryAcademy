...
-- Fecha: 2026-04-16
-- Proposito:
-- 1. Permitir vender una nueva membresia V2 desde admin
-- 2. Mover cualquier membresia activa previa a historico
-- 3. Crear un nuevo ciclo limpio de clases con ledger inicial y pago opcional
-- ============================================================================
...
-- SOURCE: 20260416_130000_add_daily_booking_cutoff.sql
